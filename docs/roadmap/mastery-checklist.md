...
Advanced Python topics I want to understand one day as I keep learning.

How to use this page like a roadmap:
...
- [Memory Management - Python/C API](https://docs.python.org/3/c-api/memory.html): explains Python's private heap and memory allocators. Lower-level, but useful for understanding what Python manages for you.
